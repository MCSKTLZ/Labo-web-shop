...
module.exports = {
  connect: () => {
    if (!dbConnector) {
      ...
      dbConnector.User.hasMany(dbConnector.Order, {
        onDelete: "cascade",
        hooks: true,
      });
      ...
      dbConnector.Order.belongsToMany(dbConnector.Product, {
        through: dbConnector.Order_Product,
      });
      dbConnector.Product.belongsToMany(dbConnector.Order, {
        through: dbConnector.Order_Product,
      });
      // le cart a plusieurs produits et le produit a plusieurs cart
      dbConnector.Cart.belongsToMany(dbConnector.Product, {
        through: dbConnector.Cart_Product,
      });
      dbConnector.Product.belongsToMany(dbConnector.Cart, {
        through: dbConnector.Cart_Product,
      });
      ...
      dbConnector.Product.belongsToMany(dbConnector.Category, {
        through: "Category_Product",
      });
      dbConnector.Category.belongsToMany(dbConnector.Product, {
        through: "Category_Product",
      });
